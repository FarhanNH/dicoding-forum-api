...
exports.up = (pgm) => {
  ...
  pgm.addConstraint('comments', 'fk_comments.threadId_threads.id', 'FOREIGN KEY(owner) REFERENCES threads(id) ON DELETE CASCADE');
};
...
exports.down = (pgm) => {
  ...
  // menghapus constraint fk_comments.threadId_threads.id pada tabel comments
